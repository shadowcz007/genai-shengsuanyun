...
// Export main ExtendedGoogleGenAI (cross-platform)
export {ExtendedGoogleGenAI} from './extended-client.js';

// Export GoogleGenAI as alias for ExtendedGoogleGenAI (for compatibility with documentation)
export {ExtendedGoogleGenAI as GoogleGenAI} from './extended-client.js';
